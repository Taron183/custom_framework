                    ...
                    <div class="collapse navbar-collapse" id="main-nav">
                        ...
                        <ul class="nav navbar-nav  navbar-right ">
                            ...
                            <li class="hidden-xs message_request" user_id="<?php echo  $_SESSION['user_id'] ?>">
                                <input type= "hidden" user_id="<?php echo  $_SESSION['user_id'] ?>" class="session_id">
                                <a href="#" id="com_t" data-toggle="sidebar-menu ">
                            ...
                            <div class="container">
                                ...
                                <div class="cover profile">
                                    ...
                                    <div class="cover-info">
                                        ...
                                        <div class="name"><a href="#"><?php  echo  $this->user['firstname']  ?>  <span class="firstnames"><?php echo $this->user['lastname'] ?></span> </a></div>
                                        <ul class="cover-nav">


                                            <li><a href="#"><i class="fa fa-fw icon-ship-wheel"></i> Timeline</a></li>
                                            <li><a href="#"><i class="fa fa-fw icon-user-1"></i> About</a></li>
                                            <li><a href="/account/friends"><i class="fa fa-fw fa-users"></i> Friends</a></li>
